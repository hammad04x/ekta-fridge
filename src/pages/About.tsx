    ...
    <main className="pt-24 pb-0 min-h-screen">
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-foreground">About ElectraZone</h1>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            ...
            <div className="glass-card p-8 aspect-square flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="font-heading text-2xl font-bold gradient-text">Since 2015</p>
      ...
      <section className="py-20 border-y border-white/5">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {values.map((v) => (
              <div key={v.title} className="glass-card p-6 text-center group hover:border-primary/30 transition-all">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary/20 to-accent/10 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {team.map((member) => (
              <div key={member.name} className="glass-card p-6 text-center">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center mx-auto mb-4 text-background font-heading font-bold text-lg">
                  {member.initials}
                </div>
